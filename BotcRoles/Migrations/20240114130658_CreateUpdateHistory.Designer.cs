...
namespace BotcRoles.Migrations
{
    ...
    [Migration("20240114130658_CreateUpdateHistory")]
    partial class CreateUpdateHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BotcRoles.Models.UpdateHistory", b =>
                {
                    b.HasOne("BotcRoles.Models.Edition", null)
                        .WithMany("UpdateHistories")
                        .HasForeignKey("EditionId");

                    b.HasOne("BotcRoles.Models.Game", null)
                        .WithMany("UpdateHistories")
                        .HasForeignKey("GameId");

                    b.HasOne("BotcRoles.Models.Player", null)
                        .WithMany("UpdateHistories")
                        .HasForeignKey("PlayerId");

                    b.HasOne("BotcRoles.Models.Role", null)
                        .WithMany("UpdateHistories")
                        .HasForeignKey("RoleId");
                });
