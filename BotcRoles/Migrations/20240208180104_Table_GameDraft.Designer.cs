...
namespace BotcRoles.Migrations
{
    ...
    [Migration("20240208180104_Table_GameDraft")]
    partial class Table_GameDraft
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BotcRoles.Models.GameDraft", b =>
                {
                    b.Property<long>("GameDraftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("GameDraftId"));
                    ...
                    b.HasKey("GameDraftId");

                    b.HasIndex("EditionId");

                    b.HasIndex("StorytellerId");

                    b.ToTable("GamesDraft");
                });
            ...
            modelBuilder.Entity("BotcRoles.Models.UpdateHistory", b =>
                {
                    b.Property<long>("UpdateHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("UpdateHistoryId"));
            ...
            modelBuilder.Entity("BotcRoles.Models.GameDraft", b =>
                {
                    ...
                    b.HasOne("BotcRoles.Models.Player", "Storyteller")
                        .WithMany("GamesDraftStoryTelling")
                        .HasForeignKey("StorytellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BotcRoles.Models.Player", b =>
                {
                    b.Navigation("GamesDraftStoryTelling");
