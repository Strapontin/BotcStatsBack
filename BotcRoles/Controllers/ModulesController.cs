...
namespace BotcRoles.Controllers
{
    ...
    public class ModulesController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("{moduleName}")]
        public ActionResult<Module> Get(string moduleName)
        {
        ...
        public IActionResult CreateModule([FromBody] JObject data)
        {
            try
            {
                ...
                List<Role>? roles = data["roles"]?.ToObject<List<Role>>();
                ...
                {
                    Role? roleDb = _db.Roles.FirstOrDefault(r => r.Name == role.Name);
                    if (roleDb == null)
                    {
        ...
        public ActionResult<IEnumerable<RoleModule>> GetRolesFromModule(long moduleId)
        {
            var rolesInModule = _db.RolesModule
