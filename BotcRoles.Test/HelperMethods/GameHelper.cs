...
namespace BotcRoles.Test.HelperMethods
{
    public static class GameHelper
    {
        ...
        {
            GamesController gamesController = new(null!, modelContext, DBHelper.GetIsStorytellerAuthorizationHandler())
            {
        ...
        {
            GamesController gamesController = new(null!, modelContext, null);
